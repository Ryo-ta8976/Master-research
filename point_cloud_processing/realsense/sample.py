...
clipping_distance_in_meters_max = 5.00  # meter
...
# 追加
# while np.count_nonzero(depth_image) < 800000:
#     depth_image = np.asanyarray(depth_frame.get_data())

print(depth_image)
print(depth_image.shape)
bg_removed = np.where((depth_image > clipping_distance_min) & (
    depth_image < clipping_distance_max), depth_image, 0)
depth = o3d.geometry.Image(np.asanyarray(bg_removed))
